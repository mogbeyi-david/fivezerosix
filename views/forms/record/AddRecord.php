    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Add New Record</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> Enter Phone Details</h4>
                        <form class="form-horizontal style-form" method="post" action="<?php echo FIVEZEROSIX . '/controllers/AddPhoneController.php'?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="phone_fault" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="amount_charged" >
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-theme" name="addPhone">Add Record</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row --
